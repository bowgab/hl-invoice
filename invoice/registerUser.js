...
Fabric_Client.newDefaultKeyValueStore({ path: store_path
    ...
    let attributes = [
        {name:"username", value:"IBM",ecert:true }, //Supplier
        {name:"username", value:"Lotus",ecert:true }, //OEM
        {name:"username", value:"UBP",ecert:true } //Bank
    ];
  ...
  console.log('Successfully enrolled member user "IBM", "Lotus", "Unionbank" ');
